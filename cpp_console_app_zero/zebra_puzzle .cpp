    ...
    Solution solve() {
        ...
        do {
            ...
            do {
                ...
                int english_index = std::find(nationalities.begin(), nationalities.end(), ENGLISH) - nationalities.begin();
                ...
                int norwegian_index = std::find(nationalities.begin(), nationalities.end(), NORWEGIAN) - nationalities.begin();
                ...
                do {
                    ...
                    int ukrainian_index = std::find(nationalities.begin(), nationalities.end(), UKRAINIAN) - nationalities.begin();
                    ...
                    do {
                        ...
                        int spanish_index = std::find(nationalities.begin(), nationalities.end(), SPANISH) - nationalities.begin();
                        ...
                        do {
                            ...
                            int japanese_index = std::find(nationalities.begin(), nationalities.end(), JAPANESE) - nationalities.begin();
                            ...
                            case ENGLISH: solution.drinksWater = "Englishman"; break;
                            case SPANISH: solution.drinksWater = "Spaniard"; break;
                            ...
                            case ENGLISH: solution.ownsZebra = "Englishman"; break;
                            case SPANISH: solution.ownsZebra = "Spaniard"; break;
